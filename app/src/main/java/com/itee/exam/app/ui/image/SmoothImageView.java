...
public class SmoothImageView extends ImageView {
    ...
    public SmoothImageView(Context context, int imageWidth, int imageHeight) {
        super(context);
    ...
    public SmoothImageView(Context context, AttributeSet attrs, int imageWidth,
                           int imageHeight) {
        super(context, attrs);
        this.imageHeight = imageHeight;
        this.imageWidth = imageWidth;
    ...
    public void setImageBitmap(Bitmap bitmap) {
        ...
        arithScaleRate();
        // 缩放到屏幕大小
        zoomTo(scaleRate, ImageActivity.screenWidth / 2f,
                ImageActivity.screenHeight / 2f);
