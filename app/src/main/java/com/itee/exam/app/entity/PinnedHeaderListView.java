...
public class PinnedHeaderListView extends ListView {
    ...
    private synchronized void createPinnedHeader(int position) {
        ...
        RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) pinnedView.getLayoutParams();
...
//                        Log.d("TAG", "recycle  " + firstVisibleItem);
    ...
    public class PinnedSectionLvAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            holder.countryCode.setTag(datas.get(position).getRuankoId());
            holder.tvContent.setText(datas.get(position).getCountry());
            holder.tvContent.setTag(datas.get(position).getSectionsTitle());
            Log.e("TAG", "test"+"...."+myData.getSort());
