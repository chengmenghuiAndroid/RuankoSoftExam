...
public class RichText extends TextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        targets = new HashSet<>();
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.ruanko_RichText);
        placeHolder = typedArray.getDrawable(R.styleable.ruanko_RichText_ruanko_placeHolder);
        errorImage = typedArray.getDrawable(R.styleable.ruanko_RichText_ruanko_errorImage);

        d_w = typedArray.getDimensionPixelSize(R.styleable.ruanko_RichText_ruanko_default_width, d_w);
        d_h = typedArray.getDimensionPixelSize(R.styleable.ruanko_RichText_ruanko_default_height, d_h);
